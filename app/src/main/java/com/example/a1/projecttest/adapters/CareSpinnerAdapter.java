...
public class CareSpinnerAdapter extends ArrayAdapter<CareEntity> implements SpinnerAdapter {

    List<CareEntity> services;
    public CareSpinnerAdapter(@NonNull Context context, List<CareEntity> services) {
